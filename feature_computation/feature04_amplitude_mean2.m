function feature04_amplitude_mean2(mainfolder,subfolder,mintrackleng,maxtrackleng)
% 
...
%         (tracklength < maxtrackleng || maxtrackleng == 0))
    ...
    mean_start=nanmean(amplitudevec(1:tracklengthhalf));
    mean_end=nanmean(amplitudevec(tracklengthhalf+1:end));
    feature=mean_start/(mean_start+mean_end);
