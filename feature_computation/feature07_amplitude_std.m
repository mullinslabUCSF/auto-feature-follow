function feature07_amplitude_std(mainfolder,subfolder,mintrackleng,maxtrackleng)
% 
...
%         (tracklength < maxtrackleng || maxtrackleng == 0))
    ...
    std_start=nanstd(amplitudevec(1:tracklengthhalf));
    std_end=nanstd(amplitudevec(tracklengthhalf+1:end));
    feature=std_start/(std_start+std_end);
